...
(defn collection
  [name]
  (str "com.etzhayyim.credits." name))

(def cell-specs {
  :getbalance {:legacy-cell "com-etzhayyim-apps-credits-getBalance"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "getbalance")]
     :required-gates common-gates
     :trigger "manifest cell getbalance"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :earncredits {:legacy-cell "com-etzhayyim-apps-credits-earnCredits"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "earncredits")]
     :required-gates common-gates
     :trigger "manifest cell earncredits"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :spendcredits {:legacy-cell "com-etzhayyim-apps-credits-spendCredits"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "spendcredits")]
     :required-gates common-gates
     :trigger "manifest cell spendcredits"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :get {:legacy-cell "com-etzhayyim-apps-credits-coverage-get"
     :phase :event
     :murakumo-node "reuben"
  ...
  :domain-knowledge {:legacy-cell "domain-knowledge"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :transaction {:legacy-cell "com-etzhayyim-apps-credits-transaction"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "transaction")]
     :required-gates common-gates
     :trigger "manifest cell transaction"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :task {:legacy-cell "com-etzhayyim-apps-hc-task"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "task")]
     :required-gates common-gates
     :trigger "manifest cell task"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
